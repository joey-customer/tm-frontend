var Login = function () {
    ...
    return {
        init: function () {
            e(), r(), s() /*,$.backstretch(set to layout login default ["../assets/pages/media/bg/1.jpg","../assets/pages/media/bg/2.jpg","../assets/pages/media/bg/3.jpg","../assets/pages/media/bg/4.jpg"],{fade:1e3,duration:8e3})*/
        }
    }
}();
